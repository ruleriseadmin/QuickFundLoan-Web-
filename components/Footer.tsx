...
const Footer = () => {
  ...
  return (
    <>
    <div className='lg:w-10/12 md:w-10/12 w-11/12 h-auto bg-[#282828] font-outfit text-[#FFFFFF] lg:rounded-[45px] md:rounded[45px] rounded-[22px] grid grid-cols-1 lg:grid-cols-12 lg:gap-16 md:grid-cols-12 mx-auto mt-20'>
        <div className='mx-auto lg:col-span-5 md:col-span-6 col-span-1 w-full flex flex-col align-middle items-center my-10 '>
          <div className='my-auto lg:w-8/12 w-11/12 md:w-8/12  mb-4 '>
            ...
            <p className='text-[16px] leading-7 font-thin'><a href="mailto:Info@quickcred.com.ng">support@quickcred.com.ng</a></p>
            ...
            <Link
            href='https://www.instagram.com/quickcredng?igsh=eTY4Y25kMzM3ZnF1'
            >
        ...
        <div className='lg:mt-20 mt-8 lg:ml-4 md:ml-2 ml-4 mb-6'>
          ...
          All rights reserved. Quickcred  &copy; {currentYear}
          </p>
        </div>
