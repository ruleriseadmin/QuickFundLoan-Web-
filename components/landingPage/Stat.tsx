  ...
  return (
    <>
      <div className='grid grid-cols-1  lg:w-8/12 gap-10 md:w-11/12 md:gap-3 w-11/12 mx-auto  sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 lg:gap-0 items-center justify-items-center font-outfit lg:my-36 md:my-36 my-28'>
        <h6 className='text-[80px] font-bold leading-none mb-2   bg-gradient-to-r from-[#ED3237] to-[#263238] bg-clip-text text-transparent text-center'>
          50M+
          <p className='text-[28px] md:text-[24px] font-bold md:font-semibold mt-2 bg-gradient-to-r from-[#ED3237] to-[#263238] bg-clip-text text-transparent text-center'>
            Loan disbursed
          </p>
        </h6>
      ...
      <div className='w-11/12 mx-auto  text-center font-outfit tracking-tighter'>
        <p className='text-[#F24C5D] text-[20px] font-semibold my-2  '>How to apply</p>
